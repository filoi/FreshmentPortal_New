...
export default class Profile extends Component {
  ...
  StatusUpdate(status){
    const universityData ={
      ...
      let that = this;
    Request.RequestHandle('students/change_status/'+this.props.match.params.id,'POST',null,function(Result){
      if(Result.status){
  ...
  getData(result) {
    if (result.status) {
      ...
      this.setState({
        ...
        written_test_result: data.writen_test_result,
    ...
    return (
      <div>
        <div className="profile-cover">
          <img className="profile-img" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTCKb1XnU6gPufsz5DpyfCd7u2fbc-ZnRWZKPHfm899c4ouARWQ"/>    
