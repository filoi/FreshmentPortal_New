...
export default class edit extends Component {
      ...
      getData(result){
        ...
        if(result.status && dataSt.length !== 0){
          ...
          this.setState({
            ...
            university_id:data.university_doc[0].name, 
    ...
    selectCoursesSpecialization(){
      ...
      if(this.state.specialization_id ==="" || this.state.course_id ===""){
        ...
        var list = {'course_id':this.state.course_id,'specialisation_id':this.state.specialization_id,'college_id':id}
                  ...
                  <Alert color="light" isOpen={this.state.visible} >
                   {alerttext}
                    ...
                    <FormGroup row >
                      ...
                      <Col xs="12" md="9">
                        <Input type="text" id="name" name="name" value={this.state.name} onChange ={this.onChange}  placeholder="College Name"  disabled/>
                    ...
                    <FormGroup row>
                      ...
                      <Col xs="12" md="9">
                      <Input type="text" id="placement_head_contact_no" name="placement_head_contact_no" value={this.state.university_id} onChange ={this.onChange}  placeholder="Placement Head Contact Number" disabled />
                    ...
                    <FormGroup row>
                      ...
                      <Col xs="12" md="9">
                        <Input type="text"  id="email" name="email" value={this.state.email} onChange ={this.onChange} placeholder="E-Mail" autoComplete="email" disabled/>
                    ...
                    <FormGroup row>
                      ...
                      <Col xs="12" md="9">
                        <Input type="text"  id="college_code" name="college_code" value={this.state.college_code} onChange ={this.onChange} placeholder="Code" disabled/>                        
                      </Col>
                    </FormGroup>
                    <FormGroup row>
                      <Col md="3">
                    ...
                    <FormGroup row >
                      ...
                      <Col xs="12" md="9">
                        <Input type="text" id="palcement_head_name" name="palcement_head_name" value={this.state.palcement_head_name} onChange ={this.onChange}  placeholder="Placement Head Name" disabled />
                        <FormFeedback>Oh noes! that name is already taken</FormFeedback>
                      </Col>
                    </FormGroup>
                    <FormGroup row >
                      ...
                      <Col xs="12" md="9">
                        <Input type="text" id="placement_head_email" name="placement_head_email" value={this.state.placement_head_email} onChange ={this.onChange}  placeholder="Placement Head Email" disabled />
                        <FormFeedback>Oh noes! that name is already taken</FormFeedback>
                      </Col>
                    </FormGroup>
                    <FormGroup row >
                      ...
                      <Col xs="12" md="9">
                        <Input type="text" id="placement_head_contact_no" name="placement_head_contact_no" value={this.state.placement_head_contact_no} onChange ={this.onChange}  placeholder="Placement Head Contact Number" disabled />
                        <FormFeedback>Oh noes! that name is already taken</FormFeedback>
                    ...
                    <FormGroup row>
                      ...
                      <Col xs="12" md="9">
                        <Input type="text" id="total_student" name="total_student" value={this.state.total_student} onChange ={this.onChange} placeholder="Total Student" disabled/>                      
                      </Col>
                    </FormGroup>
                    <FormGroup row>
                      <Col md="3">
                      ...
                      <Col xs="12" md="9">
                        <Input type="text" id="geolocation" name="geolocation" value={this.state.geolocation} onChange ={this.onChange} placeholder="Geolocation" disabled/>                      
                      </Col>
                    </FormGroup>
                    ...
                    <FormGroup row>
                      ...
                      <Col xs="12" md="9">
                      <Input type="select" id="status" name="status" value={this.state.status} onChange ={this.onChange} disabled>
