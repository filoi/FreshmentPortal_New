...
const CommonRequest = new Common();
  ...
  DeleteResponse(){
    ...
    fetch = (params = {}) => {
      ...
      if(params.university !==undefined && params.university.length === 1 ){
        searchUni = "&searchUni="+params.university[0];
      } 

      Request.RequestHandle('college?page='+params.page+searchName+searchContact+searchEmail+searchUni,'GET',null,this.printData); 
    };
