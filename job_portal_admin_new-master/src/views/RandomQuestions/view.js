...
export default class add extends Component {
    constructor(props) {
      ...
      componentDidMount = () => {
        Request.RequestHandle('question/'+this.props.match.params.id,'GET',null,this.getData); 
      }
      ...
      getData(result){
        ...
        if(result.status){
          if(result.data.length !== 0){
            ...
            let answer = data.ans.split("&&");
            let correct_ans = data.correct_ans.split("&&");
            let currect_answer = [];
            answer.map((ui,index) =>{
              correct_ans.map((val) =>{
              if(ui === val){
                currect_answer[index] = ui;
                let check_answer = "check_answer"+index;
                this.setState({[check_answer]:true});
              }
            })
          })
      ...
      handleSubmit(event) {
        ...
        Request.RequestHandle('question/'+this.props.match.params.id,'POST', JSON.stringify(universityData),this.printData); 
      }
          ...
          <Form  ref={(el) => this.myFormRef = el} onSubmit={this.handleSubmit} encType="multipart/form-data" className="form-horizontal">
                ...
                <CardBody>
                  ...
                  <FormGroup row>
                      ...
                      <Col xs="12" md="9">
                        <Input type="select"  name="category" value={this.state.category} onChange ={this.onChange} placeholder="Topic" disabled>
                    ...
                    {this.state.answerCount >= 1 &&
                      ...
                      <Col xs="11" md="8">
                        <Input type="textarea"   name="0" value={this.state.answer[0]} onChange ={this.onChangeAnswer} placeholder="Answer" disabled/>
                      </Col>
                      <Col xs="1" md="1">
                      <Label check>
                        <Input type="checkbox" onChange={(e) => this.answerCheck(e,0)} name="check_answer0" checked={this.state.check_answer0} disabled/>
                      </Label>
                      </Col>
                    </FormGroup>
                    }
                    ...
                    <FormGroup row>
                      ...
                      <Col xs="11" md="8">
                        <Input type="textarea"   name="1" value={this.state.answer[1]} onChange ={this.onChangeAnswer} placeholder="Answer" disabled/>
                      </Col>
                      <Col xs="1" md="1">
                      <Label check>
                        <Input type="checkbox" onChange={(e) => this.answerCheck(e,1)} name="check_answer1" checked={this.state.check_answer1} disabled/>
                      </Label>
                      </Col>
                    </FormGroup>
                    }
                    ...
                    <FormGroup row>
                      ...
                      <Col xs="11" md="8">
                        <Input type="textarea"   name="2" value={this.state.answer[2]} onChange ={this.onChangeAnswer} placeholder="Answer" disabled/>
                      </Col>
                      <Col xs="1" md="1">
                      <Label check>
                        <Input type="checkbox" onChange={(e) => this.answerCheck(e,2)} name="check_answer2" checked={this.state.check_answer2} disabled/>
                      </Label>
                      </Col>
                    </FormGroup>
                    }
                    ...
                    <FormGroup row>
                      ...
                      <Col xs="11" md="8">
                        <Input type="textarea"   name="3" value={this.state.answer[3]} onChange ={this.onChangeAnswer} placeholder="Answer" disabled/>
                      </Col>
                      <Col xs="1" md="1">
                      <Label check>
                        <Input type="checkbox" onChange={(e) => this.answerCheck(e,3)} name="check_answer3" checked={this.state.check_answer3} disabled/>
                      </Label>
                      </Col>
                    </FormGroup>
                    }
                    ...
                    <FormGroup row>
                      ...
                      <Col xs="11" md="8">
                        <Input type="textarea"   name="4" value={this.state.answer[4]} onChange ={this.onChangeAnswer} placeholder="Answer" disabled/>
                      </Col>
                      <Col xs="1" md="1">
                      <Label check>
                        <Input type="checkbox" onChange={(e) => this.answerCheck(e,4)} name="check_answer4" checked={this.state.check_answer4} disabled/>
                      </Label>
                      </Col>
                    </FormGroup>
                    }
