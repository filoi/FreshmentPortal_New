...
export default class Profile extends Component {
  ...
  StatusUpdate(status){
    const universityData ={
      ...
      let that = this;
    Request.RequestHandle('students/change_status/'+this.props.student,'POST',null,function(Result){
      if(Result.status){
  ...
  submitProfile(){
    ...
    .then((willDelete) => {
      Request.RequestHandle('student/submit/'+this.props.student,'GET', null,function(result){
  ...
  DeleteQuery = status => {
    ...
    Request.RequestHandle(
      "students/payment_status/" + this.props.student,
      "POST",
  ...
  editSkillSet(){
    return (
      <div>
        ...
        {this.state.written_test_result ===null ?
  ...
  formProfile() {
    return (
      ...
      >
        ...
        <div className="profile-header_2">
          ...
          <div className="progress_text_2" title={ "Profile Completeness: " + this.state.percentage + "%"}>{this.state.percentage}%</div>
