...
export default class edit extends Component {
    constructor(props) {
      ...
      componentDidMount = () => {
        ...
        Request.RequestHandle('ccs/'+this.props.match.params.id+'/courses','GET',null,this.getData); 
        var arry = [];
      ...
      getData(result){
        ...
        if(result.status && dataSt.length !== 0){
          var data = dataSt[0].college_doc[0];
          this.setState({
            name:data.name,
            email:data.email, 
          ...
          <Form  ref={(el) => this.myFormRef = el} onSubmit={this.handleSubmit} encType="multipart/form-data" className="form-horizontal">
                ...
                <Tabs selectedIndex={this.state.tabIndex} onSelect={tabIndex => this.tagSelect(tabIndex)}>
                  ...
                  <Alert color="light" isOpen={this.state.visible} >
                   {alerttext}
                    ...
                    <FormGroup row>
                      ...
                      <Col xs="12" md="9">
                      <AsyncSelect cacheOptions defaultOptions value={this.university_id} onChange={this.onChangeSelectOption} loadOptions={this.promiseOptions}  disabled/>
                      </Col>
                    </FormGroup>
                    <FormGroup row>
                      <Col md="3">
                  ...
                  <TabPanel>
                      ...
                      <Col xs="12" md="9">
                      <AsyncSelect cacheOptions defaultOptions value={this.course_id} onChange={this.onChangeCourse} loadOptions={this.promiseOptionsCourse} disabled/>
                      </Col>
                      </FormGroup>
                      <FormGroup row>
                      <Col md="3">
                      ...
                      <Col xs="12" md="9">
                      <AsyncSelect cacheOptions defaultOptions value={this.specialization_id} onChange={this.onChangeSpecializations} loadOptions={this.promiseOptionSpecialization} disabled/>
                      </Col>
                      </FormGroup>
                      <FormGroup row>
                      <Col xs="12" md="12">
